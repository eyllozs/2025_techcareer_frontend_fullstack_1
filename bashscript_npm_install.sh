...
# Special My Git untrackted
{
  ...
  "version": "1.0.0",
  "description": "[GitHub Address](https://github.com/eyllozs/2025_techcareer_frontend_fullstack_1.git)\r [Mongo Database]()\r ---",
  "main": "./dist/server.js",
  "scripts": {
...
; Cloud
MONGO_CLOUD_USERNAME=eylulozis
MONGO_CLOUD_PASSWORD=
MONGO_CLOUD_PORT=27017

; Docker
MONGO_DOCKER_USERNAME=eylulozis
